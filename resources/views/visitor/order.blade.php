    ...
    <div class="container">
        ...
        <div class="banner_link">
            <div class="abnner_link_inner">
                ...
                <a href="contact-us.html">موعد لقاء مع محامي   </a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <form class="contact_us_form" id="contactform" novalidate="novalidate">
                            ...
                            <div class="form-group col-md-12">
                                <textarea class="form-control" name="text" id="text" rows="1" placeholder="موضوع اللقاء"></textarea>
                                <span class="errorMessage" style="display: none;" id="errorText">  </span>
                            </div>

                            <div class="form-group col-md-12">
                                <button type="button" id="send-btn" value="submit" class="theme-btn btn-lg">ارسل رسالتك</button>
                            </div>
                        </form>
                    </div>
                </div>
