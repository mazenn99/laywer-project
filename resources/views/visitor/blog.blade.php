                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="newsblog-group" style="height: 500px;margin-bottom: 15px;">
                                                <div class="newsblog-imgpanel">
                                                    <img src="{{$article->image}}" alt="camera-article"
                                                         style="width:370px;height:259px">
                                                    <span class="newsblog-date" style="height: 40px;"><small>{{$article->created_at}}</small></span>
                                                </div>
                                                <div class="newsblog-conents">';
                                                    ...
                                                    <h3> {{substr($article->text , 0 , 30)}} ... <a
                                                            href="api/site/getArticle/{{$article->id}}"
                ...
                function getData(page = 1) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            //     result += '<h3> ' + response.data.data[item].text.substr(0, 100) + ' .....  <a href="api/site/getArticle/' + response.data.data[item].id + '" class="theme-btn btn-sm"> اقرا المزيد</a> </h3></div></div></div>';
                            //     ;
                            // }
                            //
                            // $('.show-blog').html(result)
